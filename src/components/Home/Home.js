...
import hi from '../../Assets/images/hello.svg'
                ...
                <Row className='g-3'>
                    <Col xl={6} className='order-2 order-xl-1'>
                        <div>
                            ...
                            <p className='text-muted fw-medium text-center text-lg-start' style={{ fontSize: '20px', marginTop: '30px', lineHeight: '40px' }}>Hi , i'm Javad khanmirzaee . A passionate Front-end React Developer based in Iran, Tehran
