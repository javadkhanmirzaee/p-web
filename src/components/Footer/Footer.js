        ...
        <div className='footer'>
            <Container>
                <Row className='text-center'>
                    <Col xl={6}>
                        <p className='text-white fw-bolder text-footer fs-5'>Copyright © 2024. All rights are reserved</p>
                    </Col>
                    <Col xl={6} className='mt-3'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24" className='me-3 home-icon' style={{color:'#f2f2f2'}}>
